export const quinceMainData = {
  ...
  event: {
    celebrant: "Luz",
    parents: {
      father: "Cudberto Pérez Hernández",
      mother: "Sandra Luz García Pérez",
  ...
  attendance: {
    whatsappNumber: "5217821075076", //+52 1 782 107 5076
  ...
  gallery: {
    ...
    images: [
      ...
      {
        id: "image7",
        src: "/images/luz07.jpg",
        alt: "Sesión Fotográfica de Luz",
        caption: "",
      },
      {
        id: "image8",
        src: "/images/luz08.jpg",
